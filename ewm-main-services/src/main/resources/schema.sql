...
(
    ...
    event_location_id        BIGINT                      REFERENCES locations (location_id) ON DELETE SET NULL,
    ...
    event_request_moderation BOOLEAN DEFAULT TRUE        NOT NULL,
    event_date               TIMESTAMP WITHOUT TIME ZONE,
    event_created_date_on    TIMESTAMP WITHOUT TIME ZONE NOT NULL,
    event_published_date_on  TIMESTAMP WITHOUT TIME ZONE
);

CREATE TABLE IF NOT EXISTS compilation
(
    compilation_id     BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    compilation_pinned BOOLEAN DEFAULT FALSE NOT NULL,
